...
function printQuote() {
  ...
  var quoteContainer = document.getElementById("text");
  var sourceContainer = document.getElementById("author");

  quoteContainer.textContent = quotes.quote;
  sourceContainer.textContent = quotes.source;
  ...
  var twt = document.getElementById("tweet-quote");
  btn.style.backgroundColor = randColor;
  twt.style.backgroundColor = randColor;
}

function tweet() {
  const twtt = document.getElementById("tweet-quote");
  var quotes = document.getElementById("text").textContent;
  var author = document.getElementById("author").textContent;

  twtt.href += "?text=" + '"' + quotes + '"' + "%0D%0A" + " - " + author;
}

const el = document.getElementById("new-quote");
if (el) el.addEventListener("click", printQuote, false);
